...
** $Header: /space/home/eng/cjm/cvs/libdprt-object/c/object_jmm.c,v 1.1 2007-09-18 17:24:41 jmm Exp $
*/
/**
 ...
 */
static char rcsid[] = "$Id: object_jmm.c,v 1.1 2007-09-18 17:24:41 jmm Exp $";
/**
...
static void Object_Calculate_FWHM(Object *w_object,int *is_stellar,float *fwhm)
{
	...
	float dummy_x,dummy_y;                      /* dummy vars for sigma calc */
  ...
  /* ********************** */
	...
	*/
	...
	/*
	  ...
	  ---------------
	*/
	Sigma_x = sqrt( dummy_x / Sum_I_horiz_cut );
	Sigma_y = sqrt( dummy_y / Sum_I_vert_cut );
	...
	*/
	...
	fprintf(test_of,"X: %f\t%f\t%f\n",dummy_x,Sum_I_horiz_cut,Sigma_x);
	fprintf(test_of,"Y: %f\t%f\t%f\n",dummy_y,Sum_I_vert_cut,Sigma_y);
